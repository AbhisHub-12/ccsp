...
```mermaid
flowchart TD
    D[Data: logs, traffic,<br/>files, emails] --> ML[ML Models]
    ML --> Det[Detection:<br/>anomalies, malware, phishing]
    ML --> Def[Defense:<br/>SOAR, EDR, adaptive firewalls]
    Det --> E[Ethics, Law<br/>& Governance]
    Def --> E
